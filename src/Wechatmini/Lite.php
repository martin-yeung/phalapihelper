...
namespace MartinYeung\PhalapiHelper\Wechatmini;
...
class Lite {
	...
	public function __construct() {
		...
		$this->notify_url = \PhalApi\DI()->config->get('app.Wechatmini')['notify_url'];
